...
- [English](#english)
  ...
  - [Current Capabilities](#current-capabilities)
    - [Boot and Platform](#boot-and-platform)
    - [CPU and Architecture](#cpu-and-architecture)
  - [Interrupts and System Calls](#interrupts-and-system-calls)
  ...
  - [Memory Management](#memory-management)
    - [Frame Allocator (bitmap + reference counts)](#frame-allocator-bitmap--reference-counts)
    - [Paging setup](#paging-setup)
    - [Heap](#heap)
    - [Copy-on-Write](#copy-on-write)
    - [Per-process address spaces](#per-process-address-spaces)
  - [Multitasking and Scheduler](#multitasking-and-scheduler)
    - [Task representation](#task-representation)
    - [Task Manager](#task-manager)
    - [Scheduler](#scheduler)
    - [Usermode trampoline (helper)](#usermode-trampoline-helper)
    - [Reaper daemon](#reaper-daemon)
    - [Synchronisation primitives](#synchronisation-primitives)
  - [ELF Loader](#elf-loader)
  - [Drivers](#drivers)
    - [Serial 8250 UART (COM1)](#serial-8250-uart-com1)
    - [PIT (Programmable Interval Timer)](#pit-programmable-interval-timer)
    - [PCI bus scanner](#pci-bus-scanner)
    - [AHCI / SATA driver](#ahci--sata-driver)
    - [Framebuffer and TTY](#framebuffer-and-tty)
    - [PS/2 Keyboard](#ps2-keyboard)
  - [Filesystems](#filesystems)
    - [File Descriptor Table](#file-descriptor-table)
    - [VFS core](#vfs-core)
    - [Block device manager](#block-device-manager)
  ...
  - [Roadmap / Future Work](#roadmap--future-work)
    - [Block 1 - Almost Done (>= 80%)](#block-1---almost-done--80)
    - [Block 2 - In Progress (30 - 70%)](#block-2---in-progress-30---70)
    - [Block 3 - To Start (0%)](#block-3---to-start-0)
...
- [Espanol](#espanol)
  ...
  - [Identificacion en Tiempo de Ejecucion](#identificacion-en-tiempo-de-ejecucion)
  - [Capacidades Actuales](#capacidades-actuales)
    - [Arranque y Plataforma](#arranque-y-plataforma)
    - [CPU y Arquitectura](#cpu-y-arquitectura)
  - [Interrupciones y Llamadas al Sistema](#interrupciones-y-llamadas-al-sistema)
    - [Tabla de Descriptores de Interrupcion (IDT)](#tabla-de-descriptores-de-interrupcion-idt)
    - [Controlador de Interrupciones Programable](#controlador-de-interrupciones-programable)
    - [Llamadas al Sistema](#llamadas-al-sistema)
  - [Gestion de Memoria](#gestion-de-memoria)
    - [Asignador de Marcos (bitmap + referencias)](#asignador-de-marcos-bitmap--referencias)
    - [Configuracion de paginacion](#configuracion-de-paginacion)
    - [Heap](#heap)
    - [Copy-on-Write](#copy-on-write-1)
    - [Espacios de direcciones por proceso](#espacios-de-direcciones-por-proceso)
  - [Multitarea y Planificador](#multitarea-y-planificador)
    - [Representacion de tareas](#representacion-de-tareas)
    - [Gestor de Tareas](#gestor-de-tareas)
    - [Planificador](#planificador)
    - [Trampolin a modo usuario (helper)](#trampolin-a-modo-usuario-helper)
    - [Daemon Reaper](#daemon-reaper)
    - [Primitivas de sincronizacion](#primitivas-de-sincronizacion)
  - [Cargador ELF](#cargador-elf)
  - [Controladores](#controladores)
    - [8250 UART (puerto serie, COM1)](#8250-uart-puerto-serie-com1)
    - [PIT (Temporizador de Intervalo Programable)](#pit-temporizador-de-intervalo-programable)
    - [Escaner del bus PCI](#escaner-del-bus-pci)
    - [Controlador AHCI / SATA](#controlador-ahci--sata)
    - [Framebuffer y TTY](#framebuffer-y-tty)
    - [Teclado PS/2](#teclado-ps2)
  - [Sistemas de Archivos](#sistemas-de-archivos)
    - [Tabla de descriptores de archivo](#tabla-de-descriptores-de-archivo)
    - [Nucleo VFS](#nucleo-vfs)
    - [Gestor de dispositivos de bloque](#gestor-de-dispositivos-de-bloque)
    - [Tabla de particiones MBR](#tabla-de-particiones-mbr)
    - [FAT16 / FAT32](#fat16--fat32-1)
    - [Ext4](#ext4-1)
  - [Manejo de Errores](#manejo-de-errores)
  - [Vision de Arquitectura](#vision-de-arquitectura)
  - [Limitaciones Conocidas](#limitaciones-conocidas)
  - [Hoja de Ruta / Trabajo Futuro](#hoja-de-ruta--trabajo-futuro)
    - [Bloque 1 - Casi terminado (>= 80%)](#bloque-1---casi-terminado--80)
    - [Bloque 2 - En curso (30 - 70%)](#bloque-2---en-curso-30---70)
    - [Bloque 3 - Por iniciar (0%)](#bloque-3---por-iniciar-0)
    - [Criterio de "Terminado"](#criterio-de-terminado)
  - [Estructura del Repositorio](#estructura-del-repositorio)
  - [Compilacion y Ejecucion](#compilacion-y-ejecucion)
  - [Pruebas](#pruebas)
  - [Como Contribuir](#como-contribuir)
    - [Reportar Issues](#reportar-issues)
    - [Enviar Parches](#enviar-parches)
    - [Estilo de Codigo](#estilo-de-codigo)
    - [Licencia y Sign-off](#licencia-y-sign-off)
  - [Maintainer / Mantenedor](#maintainer--mantenedor)
